...
@section('css')
    @parent
    <link rel="stylesheet" type="text/css" href="/dist/css/admin/home/friend-links.css">
@stop
...
@section('admin-content')
	<div class="friend-links-content admin-content">
		<div>
			<input type="button" class="admin-btn" value="添加"/>
		</div>
		<div class="link-list">
			<div class="link-item">
...
@section('js')
	@parent
    <script type="text/javascript" src='/dist/js/pages/admin/home/friend-links.js'></script>
@stop
